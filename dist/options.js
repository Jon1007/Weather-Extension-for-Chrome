...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  background-color: #f5f5f5;\n  font-family: \"Roboto\", sans-serif;\n}\n", "",{"version":3,"sources":["webpack://./src/options/options.css"],"names":[],"mappings":"AAEA;EACE,yBAAyB;EACzB,iCAAiC;AACnC","sourcesContent":["@import url(\"https://fonts.googleapis.com/css2?family=Roboto:wght@100;300;400;500;700&display=swap\");\n\nbody {\n  background-color: #f5f5f5;\n  font-family: \"Roboto\", sans-serif;\n}\n"],"sourceRoot":""}]);
// Exports
...
const App = () => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        (0,_utils_storage__WEBPACK_IMPORTED_MODULE_3__.getStoredOptions)().then((options) => setOptions(options));
    }, []);
    const handleHomeCityOptions = (homeCity) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_4__["default"], { mx: "10%", my: "2%" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Card__WEBPACK_IMPORTED_MODULE_5__["default"], null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_CardContent__WEBPACK_IMPORTED_MODULE_6__["default"], null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Grid__WEBPACK_IMPORTED_MODULE_7__["default"], { container: true, direction: "column" },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Grid__WEBPACK_IMPORTED_MODULE_7__["default"], { item: true },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_8__["default"], { variant: "h4" }, "Weather Extension Options")),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Grid__WEBPACK_IMPORTED_MODULE_7__["default"], { item: true },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Typography__WEBPACK_IMPORTED_MODULE_8__["default"], { variant: "body1" }, "Home City Name"),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_9__["default"], { fullWidth: true, variant: "standard", placeholder: "Enter a home City", value: options.homeCity, onChange: (e) => handleHomeCityOptions(e.target.value) })),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Grid__WEBPACK_IMPORTED_MODULE_7__["default"], { item: true },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Button__WEBPACK_IMPORTED_MODULE_10__["default"], { variant: "contained", color: "primary", onClick: handleSaveButtonClick, disabled: isFilesDisabled }, formState === "ready" ? "Save" : "Saving...")))))));
};
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_mui_material_Box_Box_js-node_modules_mui_material_Button_Button_js-node_-fa34eb","vendors-node_modules_mui_material_TextField_TextField_js"], () => (__webpack_require__("./src/options/options.tsx")))
